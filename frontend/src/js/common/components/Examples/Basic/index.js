                ...
                <div className="row">
                    <div className="mb-4 col-lg-8">
                        <div className="mb-4 card card-small">
                            <div className="card-header"><h6 className="m-0">Form Inputs</h6></div>
                    ...
                    <div className="mb-4 col-lg-4">
                        <div className="mb-4 card card-small">
                            <div className="card-header"><h6 className="m-0">Select Form Inputs</h6></div>
                            <Selects />
                        </div>
                        <div className="mb-4 card card-small">
                            <div className=" card-header"><h6 className="m-0">Date Type Form Inputs</h6></div>
                            <Date />
                        </div>
                    </div>
                </div>
